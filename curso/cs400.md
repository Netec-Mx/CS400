...
subtitle: "Operaciones Avanzadas en Couchbase" # COLOCAR EL NOMBRE REAL DEL CURSO
emoji: "✨" 
intro: |
  Bienvenido a la **Plataforma de Laboratorios** del curso **Operaciones Avanzadas en Couchbase**. Aquí podrás explorar diferentes configuraciones a través de prácticas guiadas. ¡Desarrolla tus habilidades y lleva tus conocimientos al siguiente nivel!
course_id: cs400 # COLOCAR EL NOMBRE DEL CURSO, ES EL NOMBRE DEL ARCHIVO MISMO Y NOMBRE DEFINIDO EN _data/courses.yaml
permalink: / 
