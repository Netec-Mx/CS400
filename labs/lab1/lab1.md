...
## 🧹 Tarea 12. Eliminar Amazon EKS y verificar la limpieza
...
{% assign results = site.data.task-results[page.slug].results %}
{% capture r12 %}{{ results[11] }}{% endcapture %}
{% include task-result.html title="Tarea finalizada" content=r12 %}

{% include support-prompt.html task="tarea12" %}
